...
def collect_season_games(client, start_date, end_date, output_dir):
    """
    ...
    while current_date <= end_dt:
        ...
        idx = (current_date - start_dt).days + 1

        print(f"\n[{idx}/{total_dates}] Checking {date_str}...", end=" ")
        ...
        try:
            ...
            if response.get('statusCode') == 200:
                ...
                if games:
                    ...
                    print(f"  Saved to: {file_path.relative_to(output_path.parent)}")
                ...
                print(f"API error: status {response.get('statusCode')}")
